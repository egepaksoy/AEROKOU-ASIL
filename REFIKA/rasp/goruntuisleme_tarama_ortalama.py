...
def image_recog_flask(picam2, port, broadcast_started, stop_event, shared_state: dict, shared_state_lock: threading.Lock):
    app = Flask(__name__)
...
try:
    ...
    while not stop_event.is_set() and tarama:
        with shared_state_lock:
