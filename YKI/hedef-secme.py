...
selecter_thrd = threading.Thread(target=gimbal_handler.gimbal_selecter, args=(stop_event, vehicle, DRONE_1_ID, server, targets, target_locker, selecter_started, False, yki_monitor), daemon=True)
